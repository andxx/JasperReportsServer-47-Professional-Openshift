...
var posX = 0;
var posY = 0;
var subobj=document.getElementById('displayFormTable');
if (subobj) {
	//alert("subobj offsetWidth:" + subobj.offsetWidth);
	//alert("subobj offsetHeight:" + subobj.offsetHeight);
...
// save view
var saveAsViewName = document.getElementById("viewName");
...
//override for help
$('help').onclick = webHelpModule.displayWebHelp;

var inputs = $$('input.corner');

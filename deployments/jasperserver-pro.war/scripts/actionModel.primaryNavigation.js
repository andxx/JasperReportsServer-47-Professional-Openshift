...
var primaryNavModule = {
    ...
    initializeNavigation : function(){
        ...
        var navId;
        var navObject;
        this.JSON =  !!$("navigationActionModel").text ? ($("navigationActionModel").text.evalJSON()).evalJSON() : {};
    ...
    showNavButtonMenu : function(event, object){
        ...
        var offsets = getBoxOffsets(object, null);
        var coordinates = {
            "menuLeft":offsets[0],
            "menuTop":offsets[1] + $(object).getHeight()
        };
        /*
    ...
    setNewLocation : function(place, params){
        ...
        window.location.href = urlContext + "/" + locObj.url + queryParams;
    },

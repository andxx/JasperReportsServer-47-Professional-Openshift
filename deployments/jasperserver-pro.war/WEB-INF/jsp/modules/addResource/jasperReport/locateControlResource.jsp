...
<t:insertTemplate template="/WEB-INF/jsp/templates/page.jsp">
    ...
    <t:putAttribute name="headerContent">
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/scripts/resource.inputControl.locate.js"></script>
                                            ...
                                            <li id="fromRepo" class="leaf">
                                                ...
                                                <spring:bind path="wrapper.inputControlPath">
                                                    <label class="control browser<c:if test="${status.error and wrapper.inputControlSource != 'LOCAL'}"> error</c:if>" for="resourceUri">
                                                        ...
                                                        <button id="browser_button" class="button action" <c:if test="${empty status.value && wrapper.inputControlSource == 'LOCAL'}">disabled="disabled"</c:if>>
                                                            <span class="wrap">

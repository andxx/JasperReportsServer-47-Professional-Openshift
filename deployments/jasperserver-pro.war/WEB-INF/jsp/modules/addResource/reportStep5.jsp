...
<t:insertTemplate template="/WEB-INF/jsp/templates/page.jsp">
    ...
    <t:putAttribute name="headerContent">
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/scripts/resource.query.locate.js"></script>
                ...
                <t:putAttribute name="bodyContent">
                    <div id="flowControls">
                        <ul class="control tabSet buttons vertical">
                            <li class="tab first">
                                <button onclick="return resourceQueryLocate.jumpTo('reportNaming');" class="button up" id="steps1_2"><span class="wrap"><spring:message code="resource.report.setup"/></span></button>
                            </li>
                            <!--/.tab-->
                            <li class="tab">
                                <!-- NOTE: tabs below are disabled until required information is entered on this page -->
                                <button onclick="return resourceQueryLocate.jumpTo('resources');" class="button up" id="step3"><span class="wrap"><spring:message code="resource.report.controlsAndReources"/></span></button>
                            </li>
                            <!--/.tab-->
                            <li class="tab">
                                <button onclick="return resourceQueryLocate.jumpTo('dataSource');" class="button up" id="step4"><span class="wrap"><spring:message code="resource.report.dataSource"/></span></button>
                            </li>
                            <!--/.tab-->
                            <li class="tab selected">
                                <button onclick="return resourceQueryLocate.jumpTo('query');" class="button up" id="step5"><span class="wrap"><spring:message code="resource.report.query"/></span></button>
                            </li>
                            <!--/.tab-->
                            <li class="tab last">
                                <button onclick="return resourceQueryLocate.jumpTo('customization');" class="button up" id="step6"><span class="wrap"><spring:message code="resource.report.customization"/></span></button>
                            </li>
                            <!--/.tab-->
                        </ul>
                        <!--/.control-->
                                                        ...
                                                        <li id="create" class="leaf">
                                                            <div class="control radio <c:if test="${queryReference.source == 'LOCAL' and status.error}"> error</c:if>">
                                                                <label class="wrap" for="LOCAL" title="<spring:message code="resource.report.defineQuery"/>">
                                                                    <a id="newQueryLink" href="#" class="<c:choose><c:when test="${status.value == 'LOCAL'}">launcher</c:when><c:otherwise>disabled</c:otherwise></c:choose>">
                                                        ...
                                                        <li id="fromRepo" class="leaf">
                                                            ...
                                                            <spring:bind path="queryReference.referenceURI">
                                                                <label  for="resourceUri" class="control browser <c:if test="${status.error}"> error</c:if>">
                                                                    ...
                                                                    <button id="browser_button" class="button action" <c:if test="${empty status.value and queryReference.source != 'CONTENT_REPOSITORY'}">disabled="disabled"</c:if>><span class="wrap"><spring:message code="button.browse"/><span class="icon"></span></span></button>

...
<t:insertTemplate template="/WEB-INF/jsp/templates/page.jsp">
    ...
    <t:putAttribute name="headerContent">
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/scripts/resource.reportResourceNaming.js"></script>
                                            ...
                                            <spring:bind path="fileResource.fileResource.parentFolder">
                                                <fieldset class="group">
                                                    <label title="<spring:message code='dialog.file.selectSaveLocation'/>" for="folderUri" class="control browser<c:if test="${status.error}"> error</c:if>">
                                                        ...
                                                        <button id="browser_button" class="button action" <c:if test="${editMode or fileResource.source=='CONTENT_REPOSITORY'}">disabled="disabled"</c:if>><span class="wrap"><spring:message code="button.browse"/><span class="icon"></span></span></button>

        ...
        <form method="post" action="flow.html">
            <t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
                ...
                <t:putAttribute name="headerContent">
                    ...
                    <script type="text/javascript"
                            src="${pageContext.request.contextPath}/scripts/resource.dataType.locate.js"></script>
                                                ...
                                                <li id="fromRepo" class="leaf">
                                                    ...
                                                    <spring:bind path="control.existingPath">
                                                        <label class="control browser<c:if test="${status.error and control.source != 'LOCAL'}"> error</c:if>" for="resourceUri">
                                                            ...
                                                            <button id="browser_button" class="button action" <c:if test="${empty status.value && control.source == 'LOCAL'}">disabled="disabled"</c:if>>
                                                                <span class="wrap">

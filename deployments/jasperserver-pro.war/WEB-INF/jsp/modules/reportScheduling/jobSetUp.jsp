                                                ...
                                                <li class="leaf">
                                                    <div id="startDateLabel" class="control radio" title="<spring:message code="report.scheduling.job.edit.tooltip.start"/>">
                                                        ...
                                                        <spring:bind path="job.trigger.startDate">
                                                            <span class="control picker inline ${status.error ? "error" : ""}" id="startOn" title="<spring:message code="report.scheduling.job.edit.trigger.tooltip.calendar"/>">
                                                                <input type="text" id="trigger_startDate" value="${status.value}" name="${status.expression}" />
                                                                <c:forEach items="${status.errorMessages}" var="error">
                                                                  <span class="message warning"><c:out value="${error}"/></span>
                                                                </c:forEach>
                                                            </span>
                                            ...
                                            <fieldset id="simpleRecurrence">
                                                ...
                                                <div class="control inline">
                                                    ...
                                                    <spring:bind path="job.trigger.recurrenceIntervalUnit">
                                                        ...
                                                        <span class="wrap">(<spring:message code="required.field"/>)</span>
                                                        <span class="control inline ${status.error ? "error" : ""}" >
                                                            <c:forEach items="${status.errorMessages}" var="error">
                                                              <span class="message warning"><c:out value="${error}"/></span>
                                                            </c:forEach>
                                                ...
                                                <ul class="list inputSet">
                                                    ...
                                                    <li class="leaf">
                                                        <spring:bind path="job.trigger.occurrenceCount">
                                                            <div class="control radio" title="<spring:message code="report.scheduling.job.edit.trigger.tooltip.interval.number"/>">
                                                                ...
                                                                <span class="control inline ${status.error ? "error" : ""}" title="<spring:message code="report.scheduling.job.edit.trigger.tooltip.interval.number"/>">
                                                    ...
                                                    <li class="leaf">
                                                        <spring:bind path="job.trigger.endDate">
                                                            <div id="calendarRepeatSet" class="control radio"  title="<spring:message code="report.scheduling.job.edit.trigger.tooltip.end.date"/>">
                                                                ...
                                                                <span class="control picker inline ${status.error ? "error" : ""}" id="repeatEndDate" title="<spring:message code="report.scheduling.job.edit.trigger.tooltip.calendar"/>">
                                                                    <input type="text" id="trigger_endDate_simple" value="${status.value}" name="${status.expression}" />
                                                                    <c:forEach items="${status.errorMessages}" var="error">
                                                                      <span class="message warning"><c:out value="${error}"/></span>
                                                                    </c:forEach>
                                                                </span>
                                                ...
                                                <ul class="list inputSet">
                                                    ...
                                                    <li id="repeatTimes" class="node"><span class="wrap label"><spring:message code="report.scheduling.job.edit.trigger.label.times"/></span>
                                                        <ul class="list">
                                                            ...
                                                            <li class="leaf">
                                                                <spring:bind path="job.trigger.endDate">
                                                                     <label class="control ${status.error ? "error" : ""}" for="${status.expression}" title="<spring:message code="report.scheduling.job.edit.trigger.tooltip.calendar"/>">
                                                                        <span class="wrap"><spring:message code="report.scheduling.job.edit.trigger.label.end"/></span>
                                                                        <input type="text" id="trigger_endDate_calendar" value="${status.value}" name="${status.expression}" />
                                                                        <c:forEach items="${status.errorMessages}" var="error">
                                                                            <span class="message warning"><c:out value="${error}"/></span>
                                                                        </c:forEach>
                                                                     </label>
